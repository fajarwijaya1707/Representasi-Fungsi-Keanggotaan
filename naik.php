...
<body>
 ...
 <div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 align="center">Representasi Kurva Linier Naik</h1>
          </div>
        </div>
       	 <div class="row">
        <div class="col-sm-8">
			        	<p align="justify" class="text_content" style="padding-left:  20px;padding-right: 50px">Linear Naik
			...
			Representasi fungsi keanggotaan untuk linear naik adalah sebagai berikut :</p>
			<br>
				<center><img src="1.jpg">
			</br><br>
			<p><i>Representasi Linear Naik</i></p></center>
			<br>
				<center><img src="2.jpg">
			</br><br>
			<p><i>Rumus Representasi Linear Naik</i></p></center>
         ...
         <div class="col-sm-4">
			 ...
			 <form action="naik.php" method="post" style="padding-bottom: 30px">
			  <div class="row">
			    <div class="col-25">
			  ...
			  <div class="row" style="border: solid;width: 500px;height: 300px ;padding:30px">
				...
				if(isset($_POST['submit'])){
					...
					$x = $_POST['nilaix'];
					if ($x <= $a) {
						echo "<h5>Dikarenakan Nilai X lebih kecil dari/sama dengan  nilai A <br>";
						echo "Maka Hasilnya adalah 0</h5>";
					}
					elseif ($x >= $b) {
						echo "<h5>Dikarenakan Nilai X lebih besar dari/sama dengan  nilai B <br>";
						echo "Maka Hasilnya adalah 1 </h5>";
					}
					else{
						$hitung = ($x - $a)/($b - $a);
						echo "<h5>Dikarenakan Nilai X berada diantara nilai A dan  nilai B <br>";
